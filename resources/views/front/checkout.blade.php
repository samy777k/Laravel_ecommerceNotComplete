...
@section('main_title', 'Checkout')
@section('breadcrump', 'Checkout')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <input name="mail_address" type="text" placeholder="Mailing Address">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="single-form form-default">
                                                ...
                                                <div class="select-items">
                                                    <select name="state" class="form-control">
                                                     ...
                                                     @foreach ($countries as $country => $nameItem)
                                                        <option value={{$country}}>{{$nameItem}}</option>
                                                     @endforeach
                                        ...
                                        <div class="col-md-12">
                                            <div class="steps-form-btn button">
                                                ...
                                                <button type="submit" class="btn btn-alt">Save &amp; Continue</a>
                                            </div>
                                        </div>
